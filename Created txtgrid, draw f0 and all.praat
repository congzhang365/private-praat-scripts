...
## 		6 -- 600dpi png
##	5. Create Textgrid for each sound
##  6. Write file name to the created textgrid
## 
...
form Input directory name
    ...
    sentence soundDir C:\Users\rolin\Desktop\trial\111
    ...
    sentence figDir C:\Users\rolin\Desktop\trial\111
...
Create Strings as file list... list 'soundDir$'/*'file_extension$'
Sort
...
for ifile to number_of_files
	...
	To TextGrid... "1", 'baseFile$'
	Set interval text: 1, 1, baseFile$
	Write to text file... 'soundDir$'\'baseFile$'.TextGrid
endfor
